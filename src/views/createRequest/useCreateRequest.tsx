...
import { createRequests, getListCategories } from '../../services/RequestsServices'
...
const useCreateRequest = () => {
  ...
  const onSubmit = (navigation: NativeStackNavigationProp<RootStackParamList, "CreateRequest", undefined>) => {
